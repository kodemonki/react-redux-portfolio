    ...
    <div className="row">
      ...
      <div className="col-sm-5 offset-sm-1">
        <div className="Home--featured">
          <h2>Featured</h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam lectus mi, semper at nulla quis, vehicula pulvinar metus. Suspendisse metus nibh, euismod a tellus at, dictum imperdiet velit. Pellentesque et pretium neque, in luctus leo. Nunc efficitur efficitur eros, eget tincidunt magna dictum et. Nunc viverra nulla id nulla volutpat, non tincidunt nibh tempor. Phasellus eget placerat sem. Sed vel odio et sem vestibulum posuere tincidunt ut erat. Curabitur rutrum nunc id porttitor molestie. Sed vel nulla id urna tincidunt condimentum. Donec rutrum velit et urna pulvinar condimentum et a neque. Mauris aliquet mi at nulla scelerisque dictum. Aenean a elit sed nisi mattis eleifend eu at dolor.</p>
        </div>
      </div>
